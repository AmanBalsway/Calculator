...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    MaterialButton buttonC,buttonBracketOpen,buttonBracketClose,buttonDiv,buttonMul,buttonAdd,
            buttonSub,buttonEquals,button0,button1,button2,button3,button4,button5,button6,
